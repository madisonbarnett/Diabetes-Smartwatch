...
STATIC_COLS   = ['age', 'sex', 'preop_dm', 'weight', 'height'] # VitalDB static cols
DYNAMIC_COLS  = ['ppg_mean', 'ppg_std', 'mean_pp_interval_s', 'std_pp_interval_s', 'ppg_freq', 'auc', 'first_deriv_max', 'first_deriv_min', 'entropy'] # VitalDB dynamic cols
...
# Count number of subjects/patients
...
model.save(save_dir / f"lstm_model2_{SUFFIX}_{DATASET}.keras")
...
print(f"\nSaved: {save_dir / f'lstm_model2_{SUFFIX}_{DATASET}.keras'}")
