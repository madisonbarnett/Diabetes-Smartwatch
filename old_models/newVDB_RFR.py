...
X = bg_df[['age', 'sex', 'preop_dm', 'weight', 'height', 'bmi', 'ppg_mean', 'ppg_std', 'ppg_mean_pp_interval_s', 
            'ppg_std_pp_interval_s', 'ppg_auc', 'ppg_first_deriv_max', 'ppg_entropy', 
...
# Training/testing columns always include demographic plus 7 most important features
train_x_if = X_train[['sex', 'age', 'height', 'weight', 'bmi', 'preop_dm', 'ppg_iqr', 'ppg_skew', 'ppg_teager_energy', 'ppg_mean_pp_interval_s', 'ppg_std', 'ppg_entropy', 'ppg_first_deriv_max']]  # Demo + Top 7 important features
test_x_if = X_test[['sex', 'age', 'height', 'weight', 'bmi', 'preop_dm', 'ppg_iqr', 'ppg_skew', 'ppg_teager_energy', 'ppg_mean_pp_interval_s', 'ppg_std', 'ppg_entropy', 'ppg_first_deriv_max']]
...
# joblib.dump(rf_model_if, './model_weights/rf_physionet.pkl', compress=3)
# print("Model saved to model_weights folder as rf_physionet.pkl")