...
feat_vdb = ['age', 'sex', 'preop_dm', 'weight', 'height', 'bmi',
            'ppg_mean', 'ppg_std', 'ppg_mean_pp_interval_s', 'ppg_std_pp_interval_s', 'ppg_auc',
            'ppg_first_deriv_max', 'ppg_entropy', 'ppg_teager_energy', 'ppg_log_energy',
