...
bg_df = bg_df.drop('patient_id', axis=1)    # Drop ID column (not a feature)
...
train_x_if = X_train[['sex', 'ppg_iqr', 'ppg_skew', 'ppg_teager_energy', 'ppg_mean_pp_interval_s', 'ppg_std']]  # Top 6 important features
test_x_if = X_test[['sex', 'ppg_iqr', 'ppg_skew', 'ppg_teager_energy', 'ppg_mean_pp_interval_s', 'ppg_std']]
